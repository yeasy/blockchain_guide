...
*   **J.P. Morgan (美国)**：开发了基于 Quorum 的 **JPM Coin**，用于实现客户间的即时支付结算，显著提升了跨境资金流动的效率。截至 2026 年，JPM Coin 及其后续机构级区块链支付能力已成为该领域的重要实践案例。
...
截至 2026 年，JPM Coin 已成为机构级数字资产支付的重要实践案例：
...
* Circle：由区块链充当支付网络，允许用户进行跨币种、跨境的快速汇款。Circle 发行的美元稳定币 USDC 是全球合规性最高的稳定币之一。截至 2026 年，其市值仍处于数百亿美元量级，广泛应用于支付结算、DeFi 领域和跨境贸易。
