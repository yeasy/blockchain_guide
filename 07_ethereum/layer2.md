...
*   **缺点**：计算生成零知识证明需要消耗大量算力；（虽然 zkEVM 已经成熟，但证明生成成本仍高于 OP）。
...
在 Dencun 升级为 Layer 2 的高效性打下基础后，Ethereum 社区继续推进协议演进。**Pectra 升级**（于 2025 年 5 月 7 日执行）已进一步优化了智能合约执行效率、改进了 EVM 性能，为去中心化应用的大规模采纳铺平了道路。
