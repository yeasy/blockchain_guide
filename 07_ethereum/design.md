...
|易用性|较难处理|易于理解和编程|
|安全性|较好|需要处理好重放攻击等情况|
|可追溯性|当前状态即由交易链构成，天然可回溯|需借助交易与事件日志回溯，当前状态本身不含历史|
...
再往后，官方路线图上的下一次升级是 Glamsterdam（开发中，目标 2026 年第四季度，截至 2026 年 9 月尚未激活），之后是计划于 2027 年的 Hegotá。更远期，以太坊仍计划实现完整的 Danksharding，进一步扩大数据可用性容量。
