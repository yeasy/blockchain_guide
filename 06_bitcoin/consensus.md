...
权益证明（Proof of Stake，PoS）最早在 2012 年被 Sunny King 和 Scott Nadal 提出，最早在 [Peercoin](https://www.peercoin.net/)（原名 PPCoin）系统中被实现，类似于现实生活中的股东机制，拥有股份越多的人越容易获取记账权（同时越倾向于维护网络的正常工作）。
