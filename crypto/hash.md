...
SHA1 （Secure Hash Algorithm）是由 NIST（National Institute of Standards and Technology）于 1995 年设计发布，它的输出为长度 160 位的 hash 值，因此抗穷举性更好。SHA-1 设计时基于和 MD4 相同原理，并且模仿了该算法。SHA-1 已被证明不具备“强抗碰撞性”。
