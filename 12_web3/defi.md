...
*   **算法稳定币**：尝试主要通过供应调节或激励机制维持锚定。TerraUSD (UST) 在 2022-05 出现严重脱锚并与 LUNA 进入死亡螺旋；[Nansen 复盘](https://www.nansen.ai/research) 将关键链上时间窗口定位在 2022-05-07 至 2022-05-11，并指出事件不应简单归因于单一攻击者。该案例说明算法锚定设计需要特别谨慎，而不是证明所有非储备型设计必然失败。
